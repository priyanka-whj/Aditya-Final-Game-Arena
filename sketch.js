...
function draw() 
{
  ...
  if(keyDown("enter"))
  {
    player1.releaseBullets();
  }

  if(keyDown("space"))
  {
   player2.releaseBullets();
  }
  if(keyDown("W"))
  {
    player1.moveUp();
  ...
  if(bulletGroup1.isTouching(player2.rect))
  {
    life2 = life2-1;
    bulletGroup1.destroyEach();
  }
  if(bulletGroup2.isTouching(player1.rect))
  {
    life1 = life1-1;
  ...
  if(life1 === 0)
  {
    textSize(25);
    fill("red");
    text("Congratulations Player 2", 370,650)
    player1.rect.destroy();
  }
  ...
  if(life2 === 0)
  {
    textSize(25);
    fill("red");
    text("Congratulations Player 1", 370, 650);
    player2.rect.destroy();
  }
